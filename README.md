...
- `docs/moe.md` - MoE method notes: what changes and why routing works.
...
3. Review the filled answers and run each `TODO` implementation cell.
...
- [Tiny Transformer with RoPE and MoE](docs/tiny-moe-lm.md)
- [RoPE](docs/rope.md)
- [MoE](docs/moe.md)
